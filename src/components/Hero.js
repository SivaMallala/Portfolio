...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I am Siva Chandu.</p>
        ...
        I am a <span className=" text-[#00c7ff]"><i>Software Engineer</i></span> passionate about creating powerful and elegant{" "}
